...
const Logadmincontrol = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`/api/log/admin/control/select?page=${page + 1}&limit=${rowsPerPage}`)
      ...
      <Box sx={{ display: 'flex', justifyContent: '', margin: 5 }}>
        ...
        <FormControl fullWidth>
            ...
            >
              ...
              <MenuItem value='Edit Building'>Edit Building</MenuItem>
              <MenuItem value='Edit Room'>Edit Room</MenuItem>
...
export default Logadmincontrol
