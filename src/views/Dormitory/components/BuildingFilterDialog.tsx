      ...
      <Box sx={{ width: 250, padding: 2 }}>
        ...
        <Box sx={{ marginTop: 2 }}>
          ...
          <Grid container spacing={0} pb={3} pt={1}>
            <Grid item xs={12}>
              <FormControlLabel
                control={<Radio checked={genderFilter === ''} onChange={() => setGenderFilter('')} size='small' />}
            ...
            <Grid item xs={12}>
              <FormControlLabel
                control={
                  <Radio checked={genderFilter === 'male'} onChange={() => setGenderFilter('male')} size='small' />
                }
            ...
            <Grid item xs={12}>
              <FormControlLabel
                control={
                  <Radio checked={genderFilter === 'female'} onChange={() => setGenderFilter('female')} size='small' />
                }
